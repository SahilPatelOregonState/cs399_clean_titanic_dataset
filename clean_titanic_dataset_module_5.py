...
def clean_titanic_dataset():
    ...
    plt.xscale("log")
    plt.title("Distribution of Fare Uncleaned (Log)")
    plt.show(fare_plot)
    plt.savefig("Fare_uncleaned.png")
    ...
    clean_fare_plot = sns.boxplot(data = df, x = "Fare")
    plt.xscale("log")
    plt.title("Distribution of Fare Cleaned (Log)")
    plt.show(clean_fare_plot)
    plt.savefig(f"{save_dir}/Fare_cleaned.png")

    clean_fare_plot = sns.histplot(data=df, x="Fare")
    plt.xscale("log")
    plt.title("Distribution of Fare Cleaned (Log)")
    plt.show(clean_fare_plot)
    plt.savefig(f"{save_dir}/Fare_cleaned.png")
    ...
    age_plot = sns.boxplot(data = df, x = "Age")
    plt.xscale("linear")
    plt.title("Distribution of Age (Uncleaned)")
    plt.show(clean_fare_plot)
    plt.savefig(f"{save_dir}/age_uncleaned.png")
    ...
    plt.show(clean_fare_plot)
    plt.savefig(f"{save_dir}/age_cleaned.png")
    ...
    plt.ylabel("Count")
    plt.show()
    plt.savefig(f"{save_dir}/survival_by_passenger_cleaned.png")
    ...
    plt.ylabel("Count")
    plt.show()
    plt.savefig(f"{save_dir}/Age_Distribution_hist_cleaned.png")
